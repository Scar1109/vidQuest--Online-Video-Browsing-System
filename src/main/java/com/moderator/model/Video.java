...
public class Video {
    ...
    // Factory method to create a video with essential attributes
	...
	public static Video createVideo(int videoID, String title, String subTitle, int userID, String description,
			String thumbnail, String videoPath, String category, String visibility, String status, String date,
			String time) {
