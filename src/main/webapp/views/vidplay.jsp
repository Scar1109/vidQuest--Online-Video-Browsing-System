...
<link rel="stylesheet" href="./videoPlayer/asserts/client.58bcd74d963009b6d099.css"
	media="all">
<link rel="stylesheet"
						...
						<div class="mediaSection--yiQ4N">
							<div class="mediaItemContainer--3BwC2">
								<div class="container--pycH7" data-w="3840" data-h="2160"
									...
									<iframe id="vimeoIframe" src="videoPlayer/web-video-player/player.html"
									...
									<div class="container--nL7QW">
										<div>
											<div class="container--RXy5A default--iYncq">
												<img src="./videoPlayer/asserts/orange.svg" class="avatar--+DPkq">
											</div>
										</div>
									...
									<div class="commentContainer--wcqd2">
										<div>
											<a class="container--RXy5A default--iYncq hoverState--vIDz9"
												...
												src="./videoPlayer/asserts/green.svg" class="avatar--+DPkq"></a>
										</div>
													...
													<div class="container--YKYLB">
														<div class="triggerWrapper--NACCC">
															<button
																...
																type="button" id="dropdown-button">
									...
									<div class="commentContainer--wcqd2">
										<div>
											<a class="container--RXy5A default--iYncq hoverState--vIDz9"
												...
												src="./videoPlayer/asserts/yellow.svg" class="avatar--+DPkq"></a>
										</div>
										<div class="commentInner--ppayY">
											<div class="commentTitles--d7obE">
									...
									<div class="commentContainer--wcqd2">
										<div>
											<a class="container--RXy5A default--iYncq hoverState--vIDz9"
												...
												src="./videoPlayer/asserts/orange.svg" class="avatar--+DPkq"></a>
										</div>
										<div class="commentInner--ppayY">
											<div class="commentTitles--d7obE">
												<a href="https://pixabay.com/users/u_q46lh2u7s7-39675521/"
