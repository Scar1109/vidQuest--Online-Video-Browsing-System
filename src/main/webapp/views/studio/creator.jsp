			...
			<div class="overview">
				...
				<div class="boxes">
					<div class="box box1">
						...
						<span class="text">Total Views</span> <span class="number">112,567</span>
					</div>
					<div class="box box2">
						<ion-icon name="chatbubbles-outline"></ion-icon>
						<span class="text">Total Comments</span> <span class="number">112,567</span>
					</div>
					<div class="box box3">
						<ion-icon name="arrow-redo-outline"></ion-icon>
						<span class="text">Total Share</span> <span class="number">112,567</span>
					</div>
				</div>
			</div>
			<div class="activity">
