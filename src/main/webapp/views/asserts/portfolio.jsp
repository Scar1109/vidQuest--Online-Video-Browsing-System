...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">VidQuest</a>
    ...
    <!-- Breadcrumb Begin -->
    <div class="breadcrumb-option spad set-bg" data-setbg="img/mountain-sunset-3840x1080.jpg">
        <div class="container">
            <div class="row">
            ...
            <div class="row portfolio__gallery">
                <div class="col-lg-4 col-md-6 col-sm-6 mix nature">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg" data-setbg="img/thumbnails/785276256-98ae4fdad94d053acd6beedff25c28b92cdfdc7abc1a5b2c73f5fd21c699f871-d_640x360.jpg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mix nature">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg" data-setbg="img/thumbnails/763232574-ee9696aadd18a68f117db0c5c793ad4c0b31f1990d46f47b685854103467d80c-d_640x360.jpg">
                            <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" class="play-btn video-popup"><i
                                    class="fa fa-play"></i></a>
                        </div>
                        <div class="portfolio__item__text">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer__option__item">
                            <h5>About us</h5>
                            <p>Welcome to vidQuest, your premier destination for high-quality stock footage and video content. We understand the power of visuals and the impact they can have on your creative projects, whether you're a filmmaker, content creator, marketer, or just someone looking to enhance your digital storytelling.</p>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="footer__option__item">
                            ...
                            <form action="#">
                                ...
                                <button type="submit"><ion-icon name="mail-outline"></ion-icon></button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <p class="footer__copyright__text">Copyright &copy;
                            ...
                            All rights reserved <i class="fa fa-heart-o"
                                aria-hidden="true"></i> by <a href="#">vidQuest</a>
                        </p>
                    </div>
                </div>
            </div>
