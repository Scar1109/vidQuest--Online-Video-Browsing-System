 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="views/admin/profile.jsp">
  ...
  <!--Start Dashboard Content-->
        ...
        <div class="row row-group m-0">
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Total Videos <span class="float-right">+4.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Total Users <span class="float-right">+1.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Total Creators <span class="float-right">+5.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Comments <span class="float-right">+2.2% <i class="zmdi zmdi-long-arrow-up"></i></span></p>
                </div>
            </div>
        </div>
    </div>
	...
	<div class="row">
     ...
     <div class="col-12 col-lg-4 col-xl-4">
        <div class="card">
           <div class="card-header">Weekly Views
             <div class="card-action">
             <div class="dropdown">
             <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown">
              <i class="icon-options"></i>
           ...
           <div class="table-responsive">
             <table class="table align-items-center">
               <tbody>
                 ...
                 <tr>
                   <td><i class="fa fa-circle text-light-1 mr-2"></i>Social Media</td>
                   <td>$2602</td>
                   <td>+25%</td>
                 </tr>
                 <tr>
	...
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header">Pending Users
		  <div class="card-action">
             <div class="dropdown">
             <a href="javascript:void();" class="dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown">
              <i class="icon-options"></i>
