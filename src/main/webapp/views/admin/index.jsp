...
<body class="bg-theme bg-theme2">
	...
	<div id="sidebar-wrapper" data-simplebar=""
		...
		<ul class="sidebar-menu do-nicescrol">
			...
			<li><a href="${pageContext.request.contextPath}/getActivityServlet"> <i class="zmdi zmdi-view-dashboard"></i> <span>Dashboard</span>
			</a></li>
					...
					<div class="row row-group m-0">
						<div class="col-12 col-lg-6 col-xl-3 border-light">
							<div class="card-body">
								...
								<p class="mb-0 text-white small-font">
									Total Videos <span class="float-right">+4.2% <i
						...
						<div class="col-12 col-lg-6 col-xl-3 border-light">
							<div class="card-body">
								...
								<p class="mb-0 text-white small-font">
									Total Users <span class="float-right">+1.2% <i
										class="zmdi zmdi-long-arrow-up"></i></span>
								</p>
							</div>
						</div>
						<div class="col-12 col-lg-6 col-xl-3 border-light">
							<div class="card-body">
								...
								<p class="mb-0 text-white small-font">
									Total Creators <span class="float-right">+5.2% <i
										class="zmdi zmdi-long-arrow-up"></i></span>
								</p>
							</div>
						</div>
						<div class="col-12 col-lg-6 col-xl-3 border-light">
							<div class="card-body">
								<h5 class="text-white mb-0">
									5630 <span class="float-right"><i
										class="zmdi zmdi-attachment-alt"></i></span>
								</h5>
								<div class="progress my-3" style="height: 3px;">
									<div class="progress-bar" style="width: 55%"></div>
								</div>
								<p class="mb-0 text-white small-font">
									Comments <span class="float-right">+2.2% <i
										class="zmdi zmdi-long-arrow-up"></i></span>
								</p>
							</div>
						</div>
						...
						<div class="card-body">
							<ul class="list-inline">
								<li class="list-inline-item"><i
									class="fa fa-circle mr-2 text-white"></i>New Visitor</li>
								<li class="list-inline-item"><i
									class="fa fa-circle mr-2 text-light"></i>Old Visitor</li>
							</ul>
						...
						<div class="table-responsive">
							<table class="table align-items-center">
								<tbody>
									...
									<tr>
										<td><i class="fa fa-circle text-light-1 mr-2"></i>Social
											Media</td>
										<td>$2602</td>
										<td>+25%</td>
									</tr>
