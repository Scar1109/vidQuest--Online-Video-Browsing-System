      ...
      <div class="col-lg-12">
        <div class="card">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control form-control-rounded" id="input-7" name="email" placeholder="Enter Your Email Address">
           </div>
           <div class="form-group">
            <label for="input-8">Mobile</label>
            <input type="text" class="form-control form-control-rounded" id="input-8" name="number" placeholder="Enter Your Mobile Number">
           </div>
           <div class="form-group">
