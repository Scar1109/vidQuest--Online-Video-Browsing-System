		...
		<div
			...
			<div class="d-flex justify-content-center">
				<div class="text-center">
					...
					<h2 class="text-white-50 mx-auto mt-2 mb-5">Discover a vast
						collection of stunning royalty-free images and royalty-free stock
						photos for your creative projects.</h2>

					<div class="input-box">
						<i class="uil uil-search"></i> <input type="text"
