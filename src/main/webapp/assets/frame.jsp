            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="section-title">
                        <h2>Categories</h2>
                        <p>Discover a vast
						collection of stunning royalty-free images and <br /> royalty-free stock
						photos for your creative projects.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="right-btn"><a href="${pageContext.request.contextPath}/retreveAllVideoServlet" target="_parent" class="primary-btn">VIew all</a></div>
                </div>
            </div>
